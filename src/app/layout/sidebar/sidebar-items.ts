...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: '/staff/collectors/riders',
    title: 'Collectors',
    moduleName: 'collectors',
    iconType: 'feather',
    icon: 'shopping-bag',
    class: '',
    groupTitle: false,
  ...
  {
    path: '/managing-director/reports/main',
    title: 'Reports',
    moduleName: 'reports',
    iconType: 'feather',
    icon: 'file-text',
  ...
  {
    path: '/managing-director/sales/allocations',
    title: 'Milk Allocations',
    moduleName: 'sales',
    iconType: 'feather',
    icon: 'activity',
  ...
  {
    path: '/managing-director/sales/totals-collections',
    title: 'Totals Collections',
    moduleName: 'sales',
    iconType: 'feather',
    icon: 'layers',
  ...
  {
    path: '/managing-director/product-sales',
    title: 'Sales Summary',
    moduleName: 'product-sales',
    iconType: 'feather',
    icon: 'briefcase',
