...
@Component({
  selector: 'app-collections-price',
  templateUrl: './collections-price.component.html',
  styleUrls: ['./collections-price.component.sass'],
})
export class CollectionsPriceComponent extends BaseComponent implements OnInit {
