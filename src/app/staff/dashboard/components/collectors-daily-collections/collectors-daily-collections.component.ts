...
@Component({
  selector: 'app-collectors-daily-collections',
  templateUrl: './collectors-daily-collections.component.html',
  styleUrls: ['./collectors-daily-collections.component.sass']
})
export class CollectorsDailyCollectionsComponent extends BaseComponent implements OnInit {
