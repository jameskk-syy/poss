...
@Component({
  selector: 'app-collector-collections-milk-price',
  templateUrl: './collector-collections-milk-price.component.html',
  styleUrls: ['./collector-collections-milk-price.component.sass'],
})
